...
candidate_picture_files = ["", r"images/dataset_raw/action1/", r"images/dataset_raw/action2/",
                           r"images/dataset_raw/action3/", r"images/dataset_raw/action4/",
                           r"images/dataset_raw/action5/"]
...
if __name__ == "__main__":
    ...
    for folderName in save_pathes[1:]:  #第一个空元素不用
        mkdir(folderName)
